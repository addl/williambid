...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var gotoDate = (this._get(inst, 'gotoCurrent') && inst.currentDay ? dateNow : today);
				...
				for (var dRow = 0; dRow < numRows; dRow++) { // create date picker rows
					...
					for (var dow = 0; dow < 7; dow++) { // create date picker days
						...
						tbody += '<td class="' +
							...
							(printDate.getTime() == dateNow.getTime() ? ' ' + this._currentClass : '') + // highlight selected day
							...
							(printDate.getTime() == dateNow.getTime() ? ' ui-state-active' : '') + // highlight selected day
